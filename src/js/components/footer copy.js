...
contactContainer.innerHTML = `
  ...
  <div class="flex justify-center space-x-8">
    ...
    <a href="https://patreon.com/WendelTytan?utm_medium=unknown&utm_source=join_link&utm_campaign=creatorshare_creator&utm_content=copyLink" target="_blank" rel="noopener noreferrer" class="transition-colors icons inline-flex items-center hover:underline texto-light tooltip gap-2" data-tooltip="Patreon">
    ...
    <a href="https://Ko-fi.com/wendetytan" target="_blank" rel="noopener noreferrer" class="transition-colors icons inline-flex items-center hover:underline texto-light tooltip gap-2" data-tooltip="Ko-Fi">
      <span class="icon-footer footer-pay bg-current inline-block"
    ...
    <a href="https://www.buymeacoffee.com/WendelTytan" target="_blank" rel="noopener noreferrer" class="transition-colors icons inline-flex items-center hover:underline texto-light tooltip gap-2" data-tooltip="Buy-Me a Coffee">
      <span class="icon-footer footer-pay bg-current inline-block"
    ...
    <a href="https://livepix.gg/wendeltytan" target="_blank" rel="noopener noreferrer" class="transition-colors icons inline-flex items-center hover:underline texto-light tooltip gap-2" data-tooltip="Live Pix">
      <span class="icon-footer footer-pay bg-current inline-block"
    ...
    <a href="https://apoia.se/wendeltytan" target="_blank" rel="noopener noreferrer" class="transition-colors icons inline-flex items-center hover:underline texto-light tooltip gap-2" data-tooltip="Apoia-SE">
