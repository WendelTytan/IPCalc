export function loadFooter(selector = "#contact .footer_contact") {
    ...
    <div class="flex justify-center space-x-8">
        <a href="https://github.com/WendelTytan" target="_blank" rel="noopener noreferrer" class="transition-colors icons tooltip" data-tooltip="GitHub">
        ...
        <a href="https://www.linkedin.com/in/wendel-vinicius-25939b181/" target="_blank" rel="noopener noreferrer" class="transition-colors icons tooltip" data-tooltip="LinkedIn">
        ...
        <a href="mailto:wendelvinicius@outlook.com.br" class="transition-colors icons tooltip" data-tooltip="Email">
        ...
        <a href="https://wendeltytan.github.io/PortfoglioTytan/" class="transition-colors icons tooltip" data-tooltip="Mais Sobre Mim">
    ...
    <div class="flex justify-center space-x-8">
        ...
        <a href="https://patreon.com/WendelTytan?utm_medium=unknown&utm_source=join_link&utm_campaign=creatorshare_creator&utm_content=copyLink" target="_blank" rel="noopener noreferrer" class="transition-colors icons inline-flex items-center hover:underline texto-terciario tooltip gap-2" data-tooltip="Patreon">
        ...
        <a href="https://Ko-fi.com/wendetytan" target="_blank" rel="noopener noreferrer" class="transition-colors icons inline-flex items-center hover:underline texto-terciario tooltip gap-2" data-tooltip="Ko-Fi">
            <span class="icon-footer footer-pay bg-current inline-block"
        ...
        <a href="https://www.buymeacoffee.com/WendelTytan" target="_blank" rel="noopener noreferrer" class="transition-colors icons inline-flex items-center hover:underline texto-terciario tooltip gap-2" data-tooltip="Buy-Me a Coffee">
            <span class="icon-footer footer-pay bg-current inline-block"
        ...
        <a href="https://livepix.gg/wendeltytan" target="_blank" rel="noopener noreferrer" class="transition-colors icons inline-flex items-center hover:underline texto-terciario tooltip gap-2" data-tooltip="Live Pix">
            <span class="icon-footer footer-pay bg-current inline-block"
        ...
        <a href="https://apoia.se/wendeltytan" target="_blank" rel="noopener noreferrer" class="transition-colors icons inline-flex items-center hover:underline texto-terciario tooltip gap-2" data-tooltip="Apoia-SE">
